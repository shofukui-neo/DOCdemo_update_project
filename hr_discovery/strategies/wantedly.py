...
def discover_from_wantedly(search_engine: SearchEngine, company_name: str, homepage: str = "") -> List[DiscoveryRecord]:
    results = search_engine.search_site("wantedly.com", company_name, "採用 OR 人事")
