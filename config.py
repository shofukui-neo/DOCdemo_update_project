...
# 「生成中…」info ボックスが消えてから純粋にこの秒数を待つ
# (web_app_operator._verify_faq_generation 内で生成中表示中はカウントしない仕様)。
# 旧 60s → 120s → 180s (2026-05-19): 生成中ガード後の DOM 反映に余裕を持たせる。
FAQ_VERIFY_TIMEOUT_SECONDS = 180
